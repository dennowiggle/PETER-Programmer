...
REM Booloader
".\esptool.exe" --chip esp32s3 --port %comport% --baud %baudrate% --before default-reset --after no-reset   write-flash -e -z --flash-mode dio --flash-freq 80m --flash-size 8MB 0x0 ".\bootloader.bin" 
REM Partions
